...
export default function PomodoroComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-l from-teal-50 via-amber-50 to-cyan-50">
      <Card className="w-full max-w-md p-6 bg-gradient-to-r from-rose-50 via-purple-50 to-indigo-50  shadow-lg rounded-lg">
